    ...
    public boolean onCommand(CommandSender sender, org.bukkit.command.Command command, String label, String[] args) {
        ...
        switch (args[0]){
            ...
            case "create":
                ...
                //迷路の情報を作成
                int width = args.length > 4 && args[4].matches("\\d+") ? Integer.parseInt(args[4]) : 1;  //幅を生成
                ...
                //迷路を生成
                world = Bukkit.getWorld(locS[0]);
                if(args[2].equals("0"))new ExtendWall(width).createMaze(locRegister, world, mate);  //壁伸ばし法
                else if(args[2].charAt(0)=='1') new StickKnockDown(width,args[2].contains("r")).createMaze(locRegister,world, mate);  //棒倒し法
                else{
